  ...
  "node_modules/dotenv/package.json"(exports, module2) {
    module2.exports = {
      _args: [
        [
          "dotenv@16.0.3",
          "C:\\Users\\Vadim_Sidorov\\Desktop\\aws-shop-be\\bff-service"
        ]
      ],
      _from: "dotenv@16.0.3",
      _id: "dotenv@16.0.3",
      ...
      _spec: "16.0.3",
      _where: "C:\\Users\\Vadim_Sidorov\\Desktop\\aws-shop-be\\bff-service",
      bugs: {
...
app.all("/*", (req, res) => {
  ...
  if (recepientURL) {
    const axiosConfig = __spreadValues({
      method: req.method,
      url: `${recepientURL}${req.originalUrl}`
    }, Object.keys(req.body || {}).length > 0 && { data: req.body });
    axios_default(axiosConfig).then((response) => {
      ...
      if (err.response) {
        ...
        res.status(HttpStatusCode2.InternalServerError).json({ error: err.message });
      }
    });
  } else {
